 ...
 */
export class GalyleoDoc extends YDocument<GalyleoDocChange> {
  constructor() {
    super();
   ...
   */
  static create(): GalyleoDoc {
    return new GalyleoDoc();
  }
  ...
  private _contentObserver = (event: Y.YMapEvent<any>): void => {
    const changes: GalyleoDocChange = {};
